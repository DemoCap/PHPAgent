...
class URLFetch {
    ...
    function urlfetch_curl($url, $payload, $method, $headers, $follow_redirects, $deadline, $validate_certificate, $requestparams) {
...
function urlfetch($url, $payload, $method, $headers, $follow_redirects, $deadline, $validate_certificate, $requestparams) {
    $urlfetch = new URLFetch();
    if(function_exists('curl_version')) {
        return $urlfetch->urlfetch_curl($url, $payload, $method, $headers, $follow_redirects, $deadline, $validate_certificate, $requestparams);
    } else {
...
function post()
{
    ...
    for ($i = 0; $i < $FetchMax; $i++) {
        $response = urlfetch($url, $payload, $method, $headers, False, $deadline, False, $requestparams);
